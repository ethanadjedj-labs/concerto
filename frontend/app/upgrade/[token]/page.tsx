      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="font-display mb-3 text-4xl font-[400] tracking-tight">
            {expired ? "Your trial ended." : "Keep your Claude Code access alive."}
          </h1>
          <p className="text-lg text-[#877c70] leading-relaxed max-w-lg mx-auto">
            {expired
              ? "Your 30-minute trial has ended. Upgrade to get full access in 5 minutes."
              : "Your trial is running. Upgrade now to keep your Claude Code access after the timer runs out."}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[rgba(217,119,87,0.35)] bg-[#1a161c] p-8 shadow-[0_0_0_1px_rgba(217,119,87,0.15),0_8px_40px_rgba(217,119,87,0.10)]">
            ...
            <div className="relative">
              ...
              <p className="mb-1 text-sm text-[#877c70]">Run Claude Code from Claude chat, up to 2 parallel runs</p>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[rgba(245,240,233,0.08)] bg-[#1a161c] p-8">
            <div className="relative">
              ...
              <p className="mb-1 text-sm text-[#877c70]">More parallel Claude Code runs, up to 6</p>
              <div className="mt-5 flex items-baseline gap-2">
        ...
        <div className="mt-8 rounded-xl border border-[rgba(245,240,233,0.07)] bg-[#1a161c] px-6 py-4 text-center">
          <p className="text-sm text-[#877c70]">
            We recommend <strong className="text-[#c4b8aa]">Claude Max</strong> — Pro&apos;s token limits run out fast with parallel Claude Code work.
          </p>
        </div>
      </div>
    </div>
